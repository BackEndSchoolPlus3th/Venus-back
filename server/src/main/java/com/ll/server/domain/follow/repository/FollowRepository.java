...
public interface FollowRepository extends JpaRepository<Follow, Long> {
    List<Follow> findMockFollowsByFollower_Id(Long followerId);

    List<Follow> findMockFollowsByFollowee_Id(Long followeeId);

    List<Follow> findMockFollowsByFollower_Nickname(String nickname);

    List<Follow> findMockFollowsByFollowee_Nickname(String nickname);
